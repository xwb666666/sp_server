 ...
 */
package cn.stylefeng.guns.cloud.libs.context.auth;
...
public class LoginContext {
    ...
    public static boolean isAdmin() {
        ...
        if (loginUser != null) {
            return loginUser.getRoleNames().contains(AuthConstants.ADMIN_NAME);
        }
    ...
    public static boolean hasAnyRoles(String roleNames) {
        ...
        LoginUser loginUser = LoginContext.me().getLoginUser();
        Set<String> roleCodes = loginUser.getRoleNames();

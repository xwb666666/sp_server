 ...
 */
package cn.stylefeng.guns.cloud.libs.validator.aop;

import cn.stylefeng.guns.cloud.libs.validator.util.CheckUtil;
...
public class ParamValidateAop {
    ...
    @Pointcut(value = "@annotation(cn.stylefeng.guns.cloud.libs.validator.stereotype.ParamValidator)")

 ...
 */
package cn.stylefeng.guns.cloud.libs.mp.page;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.stylefeng.guns.cloud.libs.context.HttpContext;
import cn.stylefeng.guns.cloud.libs.web.RequestData;
import cn.stylefeng.guns.cloud.libs.web.RequestDataHolder;
...
public class PageFactory {
    ...
    public static <T> Page<T> createPage(PageQuery pageQuery) {
        ...
        if (pageQuery != null && ObjectUtil.isNotEmpty(pageQuery.getPageSize())) {
            pageSize = pageQuery.getPageSize();
        }

        if (pageQuery != null && ObjectUtil.isNotEmpty(pageQuery.getPageNo())) {
        ...
        Page<T> page = new Page<>(pageNo, pageSize);
        if (ObjectUtil.isEmpty(pageQuery.getSort())) {
            return page;
        }

package cn.stylefeng.guns.cloud.system.modular.dbs.service.impl;
...
import cn.stylefeng.guns.cloud.system.modular.dbs.mapper.DatabaseInfoMapper;
...
public class DatabaseInfoServiceImpl extends ServiceImpl<DatabaseInfoMapper, DatabaseInfo> implements DatabaseInfoService {
    ...
    @Override
    public Page<DatabaseInfo> page(DatabaseInfoParam databaseInfoParam) {

 ...
 */
package cn.stylefeng.guns.cloud.system.core.aop;

import cn.stylefeng.guns.cloud.system.core.log.LogManager;
...
public class BusinessLogAop {
     ...
     */
    @Pointcut("@annotation(cn.stylefeng.guns.cloud.system.core.log.anno.BusinessLog)")
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        LogManager.me().executeOperationLog(
                businessLog, "1111", joinPoint, JSON.toJSONString(result));
    }
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Exception exception) {
        ...
        LogManager.me().executeExceptionLog(
                businessLog, "111", joinPoint, exception);
    }
}

...
import cn.stylefeng.guns.cloud.auth.modular.sso.consumer.SystemAppConsumer;
import cn.stylefeng.guns.cloud.auth.modular.sso.entity.AuthClient;
import cn.stylefeng.guns.cloud.auth.modular.sso.enums.ClientTypeEnum;
import cn.stylefeng.guns.cloud.auth.modular.sso.enums.LoginTypeEnum;
import cn.stylefeng.guns.cloud.auth.modular.sso.mapper.AuthClientMapper;
...
public class AuthClientServiceImpl extends ServiceImpl<AuthClientMapper, AuthClient> implements AuthClientService {
    ...
    public void add(AuthClientParam param) {
        ...
        BeanUtil.copyProperties(param, authClient);
    ...
    public AuthClientResult detail(Long clientId) {
        ...
        BeanUtil.copyProperties(authClient, result);

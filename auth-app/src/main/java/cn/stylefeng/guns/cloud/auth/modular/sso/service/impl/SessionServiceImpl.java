...
import cn.stylefeng.guns.cloud.auth.modular.sso.util.*;
...
import static cn.stylefeng.guns.cloud.auth.api.constants.AuthConstants.TOKEN_PREFIX;
    ...
    private void destroySession(LoginUser loginUser, String ticket) {
        ...
        if (tokens != null && tokens.size() > 0) {
            ...
            for (Map.Entry<String, String> entry : entries) {
                ...
                // 退出所有子系统
                if (ObjectUtil.isNotEmpty(logoutUrl)) {
